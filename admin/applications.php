							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-secondary edit_application" type="button" data-id="<?php echo $row['id'] ?>" >Review</button>
...
<script>
	...
	$(".edit_application").click(function(){
		uni_modal("Review Application","manage_application.php?id="+$(this).attr('data-id'),"mid-large")
	})
