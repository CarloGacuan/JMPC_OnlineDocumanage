					...
					<div class="card-header">
						<div class="row">
							<div class="col-lg-12">
								...
								<button class="btn btn-sm btn-block btn-dark btn-sm col-md-2 float-right" type="button" id="new_vacancy"><i class="fa fa-plus"></i> New Vacancy</button>
							</div>
						</div>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-dark view_vacancy" type="button" data-id="<?php echo $row['id'] ?>" >View</button>
										<button class="btn btn-sm btn-dark edit_vacancy" type="button" data-id="<?php echo $row['id'] ?>" >Edit</button>
